...
{
    /// <inheritdoc />
    public partial class StartProject6 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryAuthors", x => new { x.LibraryId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_LibraryAuthors_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LibraryAuthors_Libraries_LibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LibraryAuthors_AuthorId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorLibrary", x => new { x.AuthorsId, x.LibrariesId });
                    table.ForeignKey(
                        name: "FK_AuthorLibrary_Authors_AuthorsId",
                        column: x => x.AuthorsId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorLibrary_LibrariesId",
                table: "AuthorLibrary",
                column: "LibrariesId");
